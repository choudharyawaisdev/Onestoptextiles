    ...
    <div class="row">
        ...
        <div class="col-lg-4 mt-5">
            <div class="order-summary mt-4">
                <h3 class="form-label mb-4" style="font-size: 1rem;">Your Order</h3>
                
                <div class="product-mini-card">
                    <img src="https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=200">
                    <div>
                        <div style="font-weight: 600; font-size: 0.9rem;">Tailored Wool Coat</div>
                        <div class="text-muted small">Size: Custom</div>
                        <div style="color: var(--accent-color); font-weight: 600;">$180.00</div>
                    </div>
                </div>
                ...
                <button class="btn-cart mt-4">Place Order</button>
            </div>
        </div>
    </div>
</main>
